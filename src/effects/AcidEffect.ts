...
export class AcidDrop implements Particle {
    public x: number;
    public y: number;
    public life: number;
    ...
    private acidity: number;
    private viscosity: number;
    private trail: Array<{x: number, y: number, size: number}>;
...
export class AcidBubble implements Particle {
    public x: number;
    public y: number;
    public life: number;
