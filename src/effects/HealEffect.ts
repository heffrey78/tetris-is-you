...
export class HealEffect {
    ...
    private healingSparkles: HealingSparkle[] = [];
    private restorationWaves: RestorationWave[] = [];
    private lifeSpirals: LifeSpiral[] = [];
    ...
    private initializeHealEffect(): void {
    ...
    private createRestorationWave(x: number, y: number): void {
    ...
    private createHealingSparkles(centerX: number, centerY: number): void {
    ...
    private createLifeSpiral(centerX: number, centerY: number): void {
    ...
    private updateHealingSparkle(sparkle: HealingSparkle): void {
    ...
    private updateRestorationWave(wave: RestorationWave): void {
        wave.radius += 1.2;
    ...
    private updateLifeSpiral(spiral: LifeSpiral): void {
    ...
    private drawHealingSparkle(sparkle: HealingSparkle): void {
    ...
    private drawRestorationWave(wave: RestorationWave): void {
    ...
    private drawLifeSpiral(spiral: LifeSpiral): void {
        if (spiral.life <= 0 || spiral.points.length < 2) return;
