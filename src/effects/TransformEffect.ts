...
export class TransformEffect {
    ...
    private transformWaves: TransformWave[] = [];
    private morphParticles: MorphParticle[] = [];
    ...
    private initializeTransformEffect(): void {
    ...
    private createTransformWave(x: number, y: number): void {
    ...
    private createMorphParticles(centerX: number, centerY: number): void {
    ...
    private createColorRipples(centerX: number, centerY: number): void {
    ...
    private updateTransformWave(wave: TransformWave): void {
        wave.radius += 1.5;
    ...
    private updateMorphParticle(particle: MorphParticle): void {
    ...
    private updateColorRipple(ripple: ColorRipple): void {
        ripple.radius += 2;
    ...
    private getColorFromPhase(phase: number, alpha: number = 1): string {
        const hue = ((phase * 180 / Math.PI) + 180) % 360;
        return `hsla(${hue}, 80%, 60%, ${alpha})`;
    }
    
    private drawTransformWave(wave: TransformWave): void {
    ...
    private drawMorphParticle(particle: MorphParticle): void {
    ...
    private drawColorRipple(ripple: ColorRipple): void {
