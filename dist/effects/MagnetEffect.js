export class MagnetEffect {
    ...
    createIronFilings(centerX, centerY) {
    ...
    drawFieldLine(fieldLine) {
        ...
        this.ctx.quadraticCurveTo(fieldLine.controlX, fieldLine.controlY, fieldLine.endX, fieldLine.endY);
        this.ctx.stroke();
        ...
        this.ctx.lineTo(currentX - Math.cos(angle - 0.3) * arrowSize, currentY - Math.sin(angle - 0.3) * arrowSize);
        this.ctx.moveTo(currentX, currentY);
        this.ctx.lineTo(currentX - Math.cos(angle + 0.3) * arrowSize, currentY - Math.sin(angle + 0.3) * arrowSize);
        this.ctx.stroke();
        this.ctx.restore();
...
//# sourceMappingURL=MagnetEffect.js.map