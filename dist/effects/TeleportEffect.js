export class TeleportEffect {
    ...
    createPortal(x, y, isDestination) {
        this.portals.push({
            x,
            y,
            radius: 0,
    ...
    createVortexParticles(centerX, centerY) {
    ...
    createWarpBeam(startX, startY, endX, endY) {
        const segments = [];
...
//# sourceMappingURL=TeleportEffect.js.map